...
export async function generateMetadata({
  ...
  const description = t("Posts.airsoft-safety-rules.description");
  const siteName =
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: t("Posts.airsoft-safety-rules.title"),
            description: t("Posts.airsoft-safety-rules.description"),
            author: { "@type": "Organization", name: siteName },
            datePublished: "2025-10-26",
          }),
        }}
      />
        <h1 className="text-4xl md:text-5xl font-bold text-center">{t("Posts.airsoft-safety-rules.title")}</h1>
        <p className="text-center text-muted-foreground text-lg md:text-xl mt-2 mb-8">{t("Posts.airsoft-safety-rules.description")}</p>
